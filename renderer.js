  ...
  constructor() {
    ...
    this.draw = () => {
      if (t % speed === 0) {
        ...
        if (stagger === 4) {
          ctx.lineTo(this.length * 2.5 + this.gap, this.length * 1.5 + this.gap)
          this.length -= this.gap
    ...
    this.draw = () => {
      if (t % speed === 0) {
        ...
        if (stagger === 0) {
          ...
          ctx.arc(w / 2, h / 2, this.radius, this.startAngle, this.endAngle / 4)
        }
        if (stagger === 1) {
          ctx.beginPath()
          ctx.arc(
  ...
  constructor() {
    ...
    this.draw = () => {
      if (t % speed === 0) {
        ...
        if (stagger === 6) {
          ctx.strokeRect(5 * this.length, this.height, this.length, this.height)
          ctx.fillRect(5 * this.length, this.height, this.length, this.height)
          ctx.fillStyle = randomColor(0, 255, 0, 1)
        }
        if (stagger === 7) {
          ctx.strokeRect(4 * this.length, this.height, this.length, this.height)
          ctx.fillRect(4 * this.length, this.height, this.length, this.height)
          ctx.fillStyle = randomColor(0, 255, 0, 1)
        }
        if (stagger === 8) {
          ctx.strokeRect(3 * this.length, this.height, this.length, this.height)
          ctx.fillRect(3 * this.length, this.height, this.length, this.height)
          ctx.fillStyle = randomColor(0, 255, 0, 1)
        }
        if (stagger === 9) {
          ctx.strokeRect(2 * this.length, this.height, this.length, this.height)
        ...
        if (stagger === 13) {
          ctx.strokeRect(this.length, 2 * this.height, this.length, this.height)
        ...
        if (stagger === 22) {
          ctx.strokeRect(this.length, 3 * this.height, this.length, this.height)
        ...
        if (stagger === 25) {
          ctx.strokeRect(this.length, 4 * this.height, this.length, this.height)
...
class Tricordion {
  constructor() {
    ...
    this.draw = () => {
      ...
      if (t % (speed * 150) === 0) {
        if (Math.random() > 0.1) {
          ctx.shadowColor = ctx.strokeStyle = randomColor(20, 175, 0.5, 1)
        } else {
          ctx.shadowColor = 'white'
          ctx.strokeStyle = 'black'
        }
    ...
    this.draw = () => {
      if (t % speed === 0) {
        for (let i = 0; i <= this.rows; i++) {
          ...
          for (let j = 0; j <= this.cols; j++) {
            ctx.beginPath()
            ctx.strokeRect(150 * j - 150, 150 * i - 150, this.side1, this.side2)
            ctx.fillRect(150 * j - 150, 150 * i - 150, this.side1, this.side2)
          }
        }
      }
      t++
    ...
    this.draw = () => {
      if (t % speed === 0) {
        for (let i = 0; i <= this.rows; i++) {
          for (let j = 0; j <= this.cols; j++) {
            ctx.beginPath()
            ctx.arc(225 * j - 225, 225 * i - 225, this.radius, 0, 2 * Math.PI)
            ctx.stroke()
          }
        }
      }
  ...
  constructor() {
    ...
    this.draw = () => {
      if (t % speed === 0) {
        ...
        ctx.bezierCurveTo(this.x1, this.y1, this.x2, this.y2, this.dx, this.dy)
        ctx.stroke()
      }
      ctx.translate(w / 2, h / 2)
      ctx.rotate((this.rotate * Math.PI) / 180)
...
class Blends {
  constructor() {
    ...
    this.shape1 = () =>
      ctx.fillRect(this.x++, this.y, this.length++, this.length)
    this.shape2 = () => ctx.arc(this.x2, this.y2++, this.length, 0, 2 * Math.PI)
    this.shape3 = () => {
      ctx.moveTo(this.x, this.y)
      ctx.lineTo(this.x2, this.y2)
    }
