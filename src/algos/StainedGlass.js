...
export default class StainedGlass extends BA {
    constructor(ctx, w, h) {
        super(ctx, w, h);
    ...
    initializeProperties() {
        ...
        this.rand1 = BA.random(0, 3);
        this.rand2 = (BA.random(1, 359) * Math.PI) / 180;
    }
    ...
    setupDrawingStyles() {
        ...
        this.ctx.fillStyle = BA.randomColor(0, 255, 0, 1);
        this.ctx.beginPath();
    }

    draw() {
        if (this.t % this.speed === 0) {
                this.stagger = BA.random(0, 30);
            ...
            if (this.t % (this.speed * 50) === 0) {
                ...
                this.ctx.globalCompositeOperation = this.modes[BA.random(0, this.modes.length)];
