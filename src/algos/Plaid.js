...
export default class Plaid extends BA {
    constructor(ctx, w, h) {
        super(ctx, w, h);
    ...
    initializeProperties() {
        this.side1 = BA.random(20, 300);
        this.side2 = BA.random(20, 300);
    ...
    setupDrawingStyles() {
        ...
        this.ctx.fillStyle = BA.randomColor(10, 255, 0.2, 0.7);
        this.ctx.strokeStyle = BA.randomColor(10, 255, 0.2, 0.7);
        this.ctx.lineWidth = BA.random(1, 13);
    }
