...
CanvasRenderingContext2D.prototype.roundRectExtra = function roundRectExtra(
    ...
    if (typeof radius === 'number') {
        cornerRadius.lowerLeft = radius;
        cornerRadius.lowerRight = radius;
        cornerRadius.upperLeft = radius;
        cornerRadius.upperRight = radius;
    } else if (radius !== null && typeof radius === 'object') {
